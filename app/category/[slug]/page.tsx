  ...
  return (
    <div className="page-shell">
      ...
      {isMultiplayer && <section className="prose-copy mt-14">
        ...
        <h2>Public arenas and larger matches</h2><p><Link href="/games/iron-legion/">Iron Legion</Link> uses team tank battles and control-point objectives, while <Link href="/games/tung-sahur-io/">Tung Sahur IO</Link>, <Link href="/games/guardz-io/">Guardz IO</Link>, <Link href="/games/snake-war-multiplayer/">Snake War Multiplayer</Link> and <Link href="/games/survev-io/">Survev.io</Link> focus on public opponents and survival-style competition. These games are better when you want unpredictable matches rather than a fixed two-person session.</p>
